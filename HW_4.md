...
#the second line copies and saves in the current directory the files starting with 'wv' excluding the files with noaa in their name
#the for loop saves the name of the file without the extension and the first line on the data in the file into a text file called sitename
